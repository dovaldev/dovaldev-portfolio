...
/* empty css                                 */
import { c as createComponent, r as renderTemplate, m as maybeRenderHead, s as spreadAttributes, a as createAstro, b as addAttribute, d as renderSlot, e as createTransitionScope, f as renderComponent } from '../chunks/astro/server_BKSh1SVN.mjs';
...
const $$NavLink = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$NavLink;
  const props = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(props.href, "href")}${addAttribute(`text-sm text-black dark:text-white font-thin ${props.class} hover:bg-gray-200 dark:hover:bg-gray-700 rounded-lg transition-all ease-in-out py-0.5 px-2`, "class")}> ${renderSlot($$result, $$slots["default"])} </a>`;
...
const $$IconRollback = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$7, $$props, $$slots);
  Astro2.self = $$IconRollback;
  const props = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<svg fill="currentColor"${spreadAttributes(props)} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"> <g> <path d="M9.72,1.22V2.67A5.6,5.6,0,0,1,13.54,7.3H12V8.7h1.55A5.6,5.6,0,0,1,8.7,13.55V12H7.3v1.55A5.6,5.6,0,0,1,2.45,8.7H4V7.3H2.45A5.6,5.6,0,0,1,7.32,2.45V8h1.4V0H1V1.4H5.68a7,7,0,1,0,4-.18Z"></path> </g> </svg>`;
}, "/Users/lilianacristinasilvacarvalho/Desktop/ProyectosAstro/dovaldev-portfolio/src/icons/IconRollback.astro", void 0);
...
const $$Nav = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`<!-- Header 1 -->${maybeRenderHead()}<nav class="hidden w-full md:flex gap-2 justify-between"> <!-- Header 1-1 --> <div class="flex w-auto shrink"> <div title="Pagina principal de documentos" class="flex justify-center items-center shrink"> ${renderComponent($$result, "IconDoc", $$IconDoc, { "class": "size-9" })} </div> <div class="flex flex-col justify-center shrink"> <div class="flex items-center gap-2 pl-2 shrink"> <a href="/" class="text-black dark:text-white text-lg">${FILE_NAME}</a> ${renderComponent($$result, "IconStar", $$IconStar, { "class": "size-5 text-black dark:text-white ml-4" })} ${renderComponent($$result, "IconFolder", $$IconFolder, { "class": "size-5 text-black dark:text-white" })} ${renderComponent($$result, "IconCloud", $$IconCloud, { "class": "size-6 text-black dark:text-white" })} </div> <div class="flex items-center w-auto shrink"> ${renderComponent($$result, "NavLink", $$NavLink, { "href": "#" }, { "default": ($$result2) => renderTemplate`Archivo` })} ${renderComponent($$result, "NavLink", $$NavLink, { "href": "#" }, { "default": ($$result2) => renderTemplate`Editar` })} ${renderComponent($$result, "NavLink", $$NavLink, { "href": "#" }, { "default": ($$result2) => renderTemplate`Ver` })} ${renderComponent($$result, "NavLink", $$NavLink, { "href": "#" }, { "default": ($$result2) => renderTemplate`Insertar` })} ${renderComponent($$result, "NavLink", $$NavLink, { "href": "#" }, { "default": ($$result2) => renderTemplate`Formato` })} ${renderComponent($$result, "NavLink", $$NavLink, { "href": "#" }, { "default": ($$result2) => renderTemplate`Herramientas` })} ${renderComponent($$result, "NavLink", $$NavLink, { "href": "#" }, { "default": ($$result2) => renderTemplate`Extensiones` })} ${renderComponent($$result, "NavLink", $$NavLink, { "href": "#" }, { "default": ($$result2) => renderTemplate`Ayuda` })} </div> </div> </div> <!-- Header 1-2 --> <div class="flex flex-grow gap-4 justify-end items-center w-full"> <a href="https://www.linkedin.com/in/juanadoval/" class="hover:bg-gray-200 rounded-lg p-1">${renderComponent($$result, "IconLinkedin", $$IconLinkedin, { "class": "size-5 text-black dark:text-white" })}</a> <a href="https://github.com/dovaldev/" class="hover:bg-gray-200 rounded-lg p-1">${renderComponent($$result, "IconGithub", $$IconGithub, { "class": "size-5 text-black dark:text-white" })}</a> ${renderComponent($$result, "ThemeToggle", $$ThemeToggle, { "elID": "theme-toggle-btn", "menuID": "themes-menu" })} ${renderComponent($$result, "IconRollback", $$IconRollback, { "class": "size-5 text-black dark:text-white shrink-0" })} ${renderComponent($$result, "IconMessage", $$IconMessage, { "class": "size-5 text-black dark:text-white" })} <div class="bg-[#C2E7FF] rounded-3xl"> <div class="py-2.5 px-6 flex items-center gap-2"> ${renderComponent($$result, "IconLock", $$IconLock, { "class": "size-5 text-gray-800" })} <span>Compartir</span> <div class="h-5 w-[1px] bg-white ml-1"></div> ${renderComponent($$result, "IconArrowDown", $$IconArrowDown, { "class": "size-3 text-gray-800" })} </div> </div> <img src="/images/icons/dovaldev-icon.webp" class="rounded-full size-12 object-cover"> </div> </nav> <!-- Header 2 --> <nav class="hidden md:block mt-2 verflow-x-scroll whitespace-nowrap cursor-grab overflow-hidden w-full"> <ul class="flex bg-gray-100 ark:bg-gray-200 dark:bg-gray-700 w-full rounded-2xl p-2 gap-2 items-center"> <li>${renderComponent($$result, "IconSearch", $$IconSearch, { "class": "size-5 text-black dark:text-white" })}</li> <li>${renderComponent($$result, "IconUndo", $$IconUndo, { "class": "size-5 text-black dark:text-white" })}</li> <li>${renderComponent($$result, "IconRedo", $$IconRedo, { "class": "size-5 text-black dark:text-white" })}</li> <li><button class="m-0 p-1 flex justify-center items-center hover:bg-gray-200 rounded" id="download-btn">${renderComponent($$result, "IconPrint", $$IconPrint, { "class": "size-5 text-black dark:text-white" })}</button></li> <li>${renderComponent($$result, "IconText", $$IconText, { "class": "size-5 text-black dark:text-white" })}</li> <li>${renderComponent($$result, "IconFormat", $$IconFormat, { "class": "size-5 text-black dark:text-white" })}</li> <li> <select class="bg-gray-200 dark:bg-gray-700 text-black dark:text-white text-sm rounded-lg"> <option value="100">100%</option> <option value="80">80%</option> </select> </li> <div class="h-5 w-[1px] bg-white"></div> <select class="bg-gray-200 dark:bg-gray-700 text-black dark:text-white text-sm rounded-lg"> <option value="100">Texto nor...</option> </select> <li> <select class="bg-gray-200 dark:bg-gray-700 text-black dark:text-white text-sm rounded-lg"> <option value="100">PT Mo...</option> </select> </li> <div class="h-5 w-[1px] bg-white"></div> <li> <select class="bg-gray-200 dark:bg-gray-700 text-black dark:text-white text-sm rounded-lg"> <option value="100">Subtítulo</option> </select> </li> <li> <select class="bg-gray-200 dark:bg-gray-700 text-black dark:text-white text-sm rounded-lg"> <option value="100">Robot...</option> </select> </li> <div class="h-5 w-[1px] bg-white mr-1"></div> <li> <div class="flex items-center gap-2.5"> <button class="text-black dark:text-white">-</button> <input type="number" class="bg-gray-200 dark:bg-gray-700 text-black dark:text-white text-sm rounded border w-8 h-6 text-center" value="9"> <button class="text-black dark:text-white">+</button> </div> </li> <div class="h-5 w-[1px] bg-white ml-1"></div> <div class="flex gap-4 items-center"> <li class="font-semibold text-black dark:text-white">B</li> <li class="font-serif italic text-black dark:text-white">I</li> <li class="underline underline-offset-4 text-black dark:text-white">U</li> </div> </ul> </nav> <nav class="w-full flex md:hidden items-center gap-4 justify-between"> ${renderComponent($$result, "IconArrowLeft", $$IconArrowLeft, { "class": "size-8 text-black dark:text-white" })} <a href="/" class="text-black dark:text-white text-xl flex-1">${FILE_NAME}</a> ${renderComponent($$result, "ThemeToggleMobile", $$ThemeToggleMobile, {})} </nav> <nav class="flex gap-4 my-2 md:hidden"> <a href="https://www.linkedin.com/in/juanadoval/" class="hover:bg-gray-200 rounded-lg p-1">${renderComponent($$result, "IconLinkedin", $$IconLinkedin, { "class": "size-5 text-black dark:text-white" })}</a> <a href="https://github.com/dovaldev/" class="hover:bg-gray-200 rounded-lg p-1">${renderComponent($$result, "IconGithub", $$IconGithub, { "class": "size-5 text-black dark:text-white" })}</a> </nav>`;
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const pages = await Astro2.glob(/* #__PURE__ */ Object.assign({"../../content/es/page-1.mdx": () => import('../chunks/page-1_BG0ZK2Ji.mjs'),"../../content/es/page-2.mdx": () => import('../chunks/page-2_PR_xOp1b.mjs'),"../../content/es/page-3.mdx": () => import('../chunks/page-3_C77QDggJ.mjs')}), () => "../../content/es/*.mdx");
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Welcome to Astro." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="h-screen w-full overflow-hidden flex flex-col"> <header class="pt-4 px-4 w-full flex flex-col items-center"> ${renderComponent($$result2, "Nav", $$Nav, {})} </header> <div id="pages" class="flex flex-1 flex-col gap-10 items-center overflow-y-scroll scrollbar-custom p-2 md:py-5"> ${pages.map((item) => renderTemplate`${renderComponent($$result2, "item.Content", item.Content, {})}`)} </div> <!-- Footer content --> <footer class="h-10 bg-black/10 flex justify-center items-center"> <p class="text-black dark:text-white font-thin text-base">
Creado por <span class="font-bold text-yellow-300">Juan A. Doval</span> en
        Astro
</p> </footer> </main> ` })}`;
